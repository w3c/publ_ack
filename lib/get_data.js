...
async function getUserData(user_url, key) {
    ...
    try {
        ...
        console.log(`First attempt to user data failed, trying again`);
        // I know this is dangerous....
        const try_again = await getUserData(user_url, key);
        return try_again;
    }
}
...
function clean_up(separate_acks, current_members /* all_members */) {
    const clean_list = (members) => _.chain(members)
    ...
    const combine_separate = (members) => _.chain(members)
        .map((member) => {
